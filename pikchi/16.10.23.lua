...
local function tpsany()
    ...
    local function getTime()
        ...
        if nTPS <= 10 then
            local Time = getTime()
            cb.say("§6Аня§r: §b Тпс сервера ужасный - §4".. TPS.." §b:(  §b Зафиксированно в :§f "..Time.."§b - По МСК")
        
        elseif nTPS <= 15 then
            local Time = getTime()
            cb.say("§6Аня§r: §b Тпс сервера в норме - §e".. TPS.." §b^^  §b Зафиксированно в :§f "..Time.."§b - По МСК")
        elseif nTPS > 15 then 
            local Time = getTime()
            cb.say("§6Аня§r: §b Тпс сервера пушка! §a".. TPS.." §b:)  §b Зафиксированно в :§f "..Time.."§b - По МСК")
        end
